 ...
 */
open class HybridMultipleImagePickerSpec_cxx {
  /**
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridMultipleImagePickerSpec_
   ...
   * The C++ part is a `std::shared_ptr<HybridMultipleImagePickerSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridMultipleImagePickerSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridMultipleImagePickerSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridMultipleImagePickerSpec_(newCxxPart)
      return newCxxPart
    }
  }
   ...
   */
  @inline(__always)
  public func equals(other: HybridMultipleImagePickerSpec_cxx) -> Bool {
