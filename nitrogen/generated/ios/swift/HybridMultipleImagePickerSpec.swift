...
public extension HybridMultipleImagePickerSpec_protocol {
...
/// See ``HybridMultipleImagePickerSpec``
open class HybridMultipleImagePickerSpec_base {
  ...
  public func getCxxWrapper() -> HybridMultipleImagePickerSpec_cxx {
  #if DEBUG
    guard self is any HybridMultipleImagePickerSpec else {
    ...
    if let cxxWrapper = self.cxxWrapper {
      ...
      let cxxWrapper = HybridMultipleImagePickerSpec_cxx(self as! any HybridMultipleImagePickerSpec)
