...
namespace margelo::nitro::multipleimagepicker::bridge::swift {
  ...
  Func_void_std__vector_PickerResult_ create_Func_void_std__vector_PickerResult_(void* NON_NULL swiftClosureWrapper) noexcept {
  ...
  Func_void_CropResult create_Func_void_CropResult(void* NON_NULL swiftClosureWrapper) noexcept {
  ...
  Func_void_CameraResult create_Func_void_CameraResult(void* NON_NULL swiftClosureWrapper) noexcept {
  ...
  std::shared_ptr<HybridMultipleImagePickerSpec> create_std__shared_ptr_HybridMultipleImagePickerSpec_(void* NON_NULL swiftUnsafePointer) noexcept {
  ...
  void* NON_NULL get_std__shared_ptr_HybridMultipleImagePickerSpec_(std__shared_ptr_HybridMultipleImagePickerSpec_ cppType) {
