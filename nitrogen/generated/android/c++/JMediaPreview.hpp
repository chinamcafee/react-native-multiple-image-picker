...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/MediaPreview;";
  ...
  public:
    ...
    static jni::local_ref<JMediaPreview::javaobject> fromCpp(const MediaPreview& value) {
      using JSignature = JMediaPreview(jni::alias_ref<JResultType>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
