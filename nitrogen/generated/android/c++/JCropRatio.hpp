...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/CropRatio;";
  ...
  public:
    ...
    static jni::local_ref<JCropRatio::javaobject> fromCpp(const CropRatio& value) {
      using JSignature = JCropRatio(jni::alias_ref<jni::JString>, double, double);
      static const auto clazz = javaClassStatic();
