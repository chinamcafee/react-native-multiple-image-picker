...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/Func_void_std__vector_PickerResult_;";
   ...
   */
  class JFunc_void_std__vector_PickerResult__cxx final: public jni::HybridClass<JFunc_void_std__vector_PickerResult__cxx, JFunc_void_std__vector_PickerResult_> {
  public:
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/Func_void_std__vector_PickerResult__cxx;";
