...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/PickerCameraConfig;";
  ...
  public:
    ...
    static jni::local_ref<JPickerCameraConfig::javaobject> fromCpp(const PickerCameraConfig& value) {
      using JSignature = JPickerCameraConfig(jni::alias_ref<JCameraDevice>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
