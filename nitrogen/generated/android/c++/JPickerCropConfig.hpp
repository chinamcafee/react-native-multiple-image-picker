...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/PickerCropConfig;";
  ...
  public:
    ...
    static jni::local_ref<JPickerCropConfig::javaobject> fromCpp(const PickerCropConfig& value) {
      using JSignature = JPickerCropConfig(jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JArrayClass<JCropRatio>>, jni::alias_ref<JCropRatio>, jni::alias_ref<jni::JBoolean>);
      static const auto clazz = javaClassStatic();
