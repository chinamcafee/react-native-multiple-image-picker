...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/NitroPreviewConfig;";
  ...
  public:
    ...
    static jni::local_ref<JNitroPreviewConfig::javaobject> fromCpp(const NitroPreviewConfig& value) {
      using JSignature = JNitroPreviewConfig(jni::alias_ref<JLanguage>, jni::alias_ref<jni::JBoolean>);
      static const auto clazz = javaClassStatic();
