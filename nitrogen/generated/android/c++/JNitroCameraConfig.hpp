...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/NitroCameraConfig;";
  ...
  public:
    ...
    static jni::local_ref<JNitroCameraConfig::javaobject> fromCpp(const NitroCameraConfig& value) {
      using JSignature = JNitroCameraConfig(jni::alias_ref<JMediaType>, jni::alias_ref<JPresentation>, jni::alias_ref<JLanguage>, jni::alias_ref<JPickerCropConfig>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JDouble>, jni::alias_ref<JCameraDevice>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
