...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/Func_void_CameraResult;";
   ...
   */
  class JFunc_void_CameraResult_cxx final: public jni::HybridClass<JFunc_void_CameraResult_cxx, JFunc_void_CameraResult> {
  public:
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/Func_void_CameraResult_cxx;";
