...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/Func_void_CropResult;";
   ...
   */
  class JFunc_void_CropResult_cxx final: public jni::HybridClass<JFunc_void_CropResult_cxx, JFunc_void_CropResult> {
  public:
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/Func_void_CropResult_cxx;";
