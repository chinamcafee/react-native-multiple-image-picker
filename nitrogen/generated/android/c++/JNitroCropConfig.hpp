...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/NitroCropConfig;";
  ...
  public:
    ...
    static jni::local_ref<JNitroCropConfig::javaobject> fromCpp(const NitroCropConfig& value) {
      using JSignature = JNitroCropConfig(jni::alias_ref<JLanguage>, jni::alias_ref<JPresentation>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JArrayClass<JCropRatio>>, jni::alias_ref<JCropRatio>, jni::alias_ref<jni::JBoolean>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        [&]() {
          ...
          for (size_t __i = 0; __i < __size; __i++) {
            ...
            auto __elementJni = JCropRatio::fromCpp(__element);
