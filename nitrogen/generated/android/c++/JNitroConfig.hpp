...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/NitroConfig;";
  ...
  public:
    ...
    static jni::local_ref<JNitroConfig::javaobject> fromCpp(const NitroConfig& value) {
      using JSignature = JNitroConfig(jni::alias_ref<JMediaType>, jni::alias_ref<jni::JArrayClass<JPickerResult>>, jni::alias_ref<JSelectBoxStyle>, jni::alias_ref<JSelectMode>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<JPickerCropConfig>, jni::alias_ref<JText>, jni::alias_ref<JLanguage>, jni::alias_ref<JTheme>, jni::alias_ref<JPresentation>, jni::alias_ref<JPickerCameraConfig>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        [&]() {
          ...
          for (size_t __i = 0; __i < __size; __i++) {
            ...
            auto __elementJni = JPickerResult::fromCpp(__element);
