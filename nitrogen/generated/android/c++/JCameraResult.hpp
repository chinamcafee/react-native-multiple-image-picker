...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/CameraResult;";
  ...
  public:
    ...
    static jni::local_ref<JCameraResult::javaobject> fromCpp(const CameraResult& value) {
      using JSignature = JCameraResult(jni::alias_ref<jni::JString>, jni::alias_ref<JResultType>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
