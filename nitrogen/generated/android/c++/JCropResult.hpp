...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/multipleimagepicker/CropResult;";
  ...
  public:
    ...
    static jni::local_ref<JCropResult::javaobject> fromCpp(const CropResult& value) {
      using JSignature = JCropResult(jni::alias_ref<jni::JString>, double, double);
      static const auto clazz = javaClassStatic();
