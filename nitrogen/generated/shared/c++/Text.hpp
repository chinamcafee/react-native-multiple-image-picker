  ...
  struct JSIConverter<margelo::nitro::multipleimagepicker::Text> final {
    static inline margelo::nitro::multipleimagepicker::Text fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::multipleimagepicker::Text(
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "finish"))),
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "original"))),
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "preview"))),
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "edit")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::multipleimagepicker::Text& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "finish"), JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.finish));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "original"), JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.original));
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "edit"), JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.edit));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "finish")))) return false;
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "original")))) return false;
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "edit")))) return false;
      return true;
    }
  };
