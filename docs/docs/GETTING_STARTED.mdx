...
Install [react-native-multiple-image-picker-editor](https://www.npmjs.com/package/react-native-multiple-image-picker-editor) through npm:
...
```bash
yarn add @chinamcafee/react-native-multiple-image-picker
...
```bash
npx expo install @chinamcafee/react-native-multiple-image-picker
